      ...
      scenes: [
        {
          ...
          prompt: `Place every person visible in this booth photo as Hollywood A-list celebrities arriving at a major movie premiere red carpet. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with designer evening wear — a tailored tuxedo or elegant floor-length gown. All subjects stand confidently together, full body visible.
...
Canon 85mm f/1.4, shallow DOF, cinematic bokeh, slight film grain, ultra photorealistic, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as Oscar Award winners on the Academy Awards stage at the Dolby Theatre. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with formal gala attire — a classic tuxedo or spectacular evening gown. Each subject holds a golden Oscar statuette. Full body visible.
...
Sony A7R IV 50mm f/2.8, ultra photorealistic, cinematic award lighting, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as world-famous celebrities featured on a massive illuminated Times Square billboard at night. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], they appear in stylish contemporary fashion as a large-scale portrait filling the giant billboard, full body visible.
...
Sony A7R IV 24mm f/4.0, ultra photorealistic, night urban photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as legendary Hollywood film directors on a professional movie production set. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with stylish smart-casual director attire — dark jeans, shirt and jacket. Each subject sits in a canvas director's chair with their name on the back. Full body visible.
      ...
      scenes: [
        {
          ...
          prompt: `Place every person visible in this booth photo as royalty seated on an ornate golden throne in a grand European palace. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with magnificent regal royal robes — deep purple velvet with ermine fur trim, gold brocade, jeweled accessories and a royal crown. All subjects seated together on the grand throne, full body visible.
...
Hasselblad H6D-100c 80mm f/2.8, ultra photorealistic, regal formal portrait lighting, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as powerful medieval kings and queens in a grand stone castle. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with a jeweled crown, magnificent royal robe with ermine fur trim, holding a golden scepter. All subjects stand together confidently, full body visible.
...
Canon EOS R5 50mm f/1.8, ultra photorealistic, cinematic medieval portrait lighting, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as magnificent royalty in a grand Versailles-style palace ballroom. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with an elaborate royal ball gown with gold embroidery and diamond tiara, or a formal royal military dress uniform. Each subject holds a bouquet of roses. Full body visible.
...
Nikon Z9 85mm f/1.4, ultra photorealistic, baroque grand portrait lighting, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as Mughal emperors and empresses in a grand Mughal imperial palace. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with ornate Mughal imperial attire — richly embroidered sherwani or anarkali, jeweled turban with aigrette feather ornament, multiple pearl necklaces and kundan gemstone jewelry. Full body visible.
      ...
      scenes: [
        {
          ...
          prompt: `Place every person visible in this booth photo on a grand corporate annual day event stage as award winners. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with smart professional corporate formal attire — a well-fitted suit and tie or formal dress. Each subject holds a gleaming award trophy on stage. Full body visible.
...
Canon 1DX Mark III 135mm f/2.0, ultra photorealistic, professional corporate event photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as prestigious award recipients receiving a trophy at an elegant corporate ceremony. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with formal evening corporate wear — a sharp tuxedo or elegant formal dress. Each subject holds a gleaming glass-and-metal trophy aloft. Full body visible.
...
Sony A1 85mm f/1.8, ultra photorealistic, luxury event photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as powerful CEOs delivering a keynote speech at a major corporate conference stage. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with premium executive business attire — a sharp tailored suit or executive dress. Subjects stand at a sleek glass podium confidently addressing the audience. Full body visible.
...
Canon R3 70mm f/2.8, ultra photorealistic, corporate conference photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo celebrating together at a grand corporate annual day party. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with elegant party attire — a cocktail suit or party dress. Each subject holds a champagne flute with a natural joyful expression. Full body visible.
      ...
      scenes: [
        {
          ...
          prompt: `Place every person visible in this booth photo as luxury travelers at a Maldives overwater bungalow resort. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with elegant resort wear — linen shirts, sundresses or premium swim cover-ups. All subjects stand or sit relaxed on the bungalow deck, full body visible.
...
Canon 5D Mark IV 35mm f/4.0, ultra photorealistic, luxury travel lifestyle photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as luxury superyacht owners on the deck of a massive private yacht. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with designer nautical luxury wear — crisp white linen, designer sunglasses, casual blazer or elegant summer outfit. All subjects stand confidently on the yacht deck, full body visible.
...
Leica SL2 50mm f/2.0, ultra photorealistic, luxury lifestyle photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo at a glamorous luxury beach club during golden hour. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with stylish beach party attire — tropical prints, beach chic clothing or elegant resort fashion. Each subject holds a colorful cocktail glass. Full body visible.
...
Sony A7 IV 35mm f/2.8, ultra photorealistic, lifestyle beach photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo on an African safari adventure atop a luxury vehicle in the savanna. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with premium safari gear — khaki bush shirt, cargo trousers, wide-brimmed hat, binoculars around the neck. All subjects sit together on top of an open-roof Land Cruiser, full body visible.
...
ABSOLUTE PRIORITY: Preserve each person's real facial identity above everything else. The face must be unmistakably the same person from the photo.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo in an Icelandic winter landscape under a spectacular Northern Lights display. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with a heavy insulated parka, knit hat, scarf and gloves. Visible breath vapor from extreme cold. Subjects stand together, faces turned upward in wonder, full body visible.
...
Sony A7S III 20mm f/1.8 ISO 3200, ultra photorealistic, long-exposure aurora night photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo in a magical Christmas winter wonderland outdoor scene. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with an elegant winter coat in deep red or forest green, knit scarf and gloves. Snowflakes settle lightly on hair, shoulders and coat fabric. Full body visible.
...
Canon R6 50mm f/1.4, ultra photorealistic, Christmas lifestyle photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo inside a breathtaking fantasy ice palace. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with elegant winter formal attire — a structured white or ice-blue formal coat or gown with silver accents. Visible breath vapor. Full body visible.
      ...
      scenes: [
        {
          ...
          prompt: `Place every person visible in this booth photo as subjects in an elegant classic studio portrait in the style of mid-20th century fine photography. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with classic vintage formal wear — a tailored suit with pocket square or an elegant period dress with pearl accessories. All subjects pose together in a classic portrait grouping, full body visible.
...
Hasselblad 500cm 80mm f/5.6 medium format film aesthetic, subtle film grain, slight halation, ultra photorealistic vintage portrait photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo in a beautiful English country garden during golden afternoon. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with elegant English countryside attire — a floral summer dress or a linen suit in cream or sky blue with a pocket square. All subjects stand together naturally in the garden, full body visible.
...
Canon 85mm f/1.2L, ultra photorealistic, English countryside lifestyle portrait, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo in a high-end professional fashion photography studio as editorial models. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with premium fashion editorial attire — sophisticated designer clothing, well-fitted and styled. All subjects stand together on the white seamless in natural editorial poses, full body visible.
...
Hasselblad H6D-100c 110mm f/3.5, ultra photorealistic, Vogue fashion photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo at a beautifully styled luxury garden picnic. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with stylish casual garden attire — relaxed linen shirts, summer dresses or smart casual separates in soft pastel tones. All subjects sit or stand naturally together at the picnic, full body visible.
      ...
      scenes: [
        {
          ...
          prompt: `Place every person visible in this booth photo as NASA astronauts aboard the International Space Station with Earth visible through the observation window. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with a realistic NASA EMU spacesuit or blue NASA flight suit with mission patches and American flag on shoulder. All subjects float or stand together in the ISS, full body visible.
...
Nikon D5 24mm f/2.8, ultra photorealistic, NASA documentary photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as Mars explorers standing on the Martian surface. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with a realistic Mars exploration pressure suit — white and orange full-body suit with clear visor helmet, mission patches, air supply backpack and equipment pouches. Full body visible.
...
Canon R5 35mm f/5.6, ultra photorealistic, cinematic sci-fi photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as pilots and crew in the cockpit of a futuristic interstellar spacecraft. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with a sleek futuristic flight suit — charcoal grey with navy and white accents, mission insignia patches, thin communication earpiece. All subjects seated in pilot chairs or standing at control stations, full body visible.
...
ARRI ALEXA 35mm anamorphic, ultra photorealistic, cinematic sci-fi with subtle anamorphic lens flares, 8K.`
        },
        {
          ...
          name: 'Alien World',
          gradient: 'linear-gradient(135deg, #1a0033, #330066)',
          prompt: `Place every person visible in this booth photo as space explorers standing on the surface of an exotic alien planet. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with a futuristic space explorer suit — sleek matte black and silver, helmet visor up showing face, mission insignia and breathing apparatus. Full body visible.
      ...
      scenes: [
        {
          ...
          prompt: `Place every person visible in this booth photo as Spartan warriors on an ancient Greek battlefield. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with authentic Spartan warrior armor — hammered bronze breastplate, bronze greaves, a Corinthian crested helmet pushed back revealing the face, round hoplon shield with lambda symbol, and a long spear. All subjects stand together in warrior formation, full body visible.
...
Canon 1DX Mark III 85mm f/2.0, ultra photorealistic, 300-movie-style epic cinematic photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as elite Japanese samurai in a cherry blossom garden. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with ornate traditional samurai armor — full yoroi-style suit, kabuto helmet pushed up revealing the face, katana in hand and wakizashi at the hip. All subjects stand together, full body visible.
...
Fujifilm GFX 100S 110mm f/2.0, ultra photorealistic, epic Kurosawa-inspired cinematic photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as fierce Viking warriors on the prow of a Viking longship at sea. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with Viking warrior battle attire — chainmail hauberk over wool tunic, leather bracers, fur cloak, iron helmet, holding a bearded axe or round painted shield. All subjects stand together on the ship's prow, full body visible.
...
Nikon Z9 50mm f/4.0, ultra photorealistic, Vikings-series cinematic photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as noble medieval knights in a castle courtyard. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with gleaming polished full Gothic plate armor — mirror-polished steel breastplate, pauldrons, gauntlets and greaves. Great helm tucked under one arm, broadsword in the other, surcoat with royal crest. Full body visible.
      ...
      scenes: [
        {
          ...
          prompt: `Place every person visible in this booth photo as rock stars performing on a massive stadium concert stage. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with iconic rock star stage attire — leather jacket, ripped jeans, band tee or dramatic stage costume. Subjects perform naturally with a microphone stand or electric guitar. Full body visible.
...
Canon 1DX Mark III 400mm f/2.8, ultra photorealistic, professional concert photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as world-famous DJs performing at a luxury nightclub. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with stylish DJ stage attire — fashion-forward club wear, designer shirt or jacket, headphones around the neck. Subjects positioned behind a professional DJ setup actively mixing. Full body visible.
...
Sony A7S III 35mm f/1.4 ISO 6400, ultra photorealistic, professional nightclub photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as Grammy Award winners on the Grammy Awards stage. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with glamorous award show attire — a designer gown or highly stylized suit. Each subject holds a golden gramophone Grammy trophy raised above their head in triumph. Full body visible.
...
Canon 300mm f/2.8 telephoto, ultra photorealistic, premium award show photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as the stars of a high-production music video shoot. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with high-fashion music video attire — designer couture pieces, bold colors and statement accessories for a luxury music video. All subjects perform naturally to camera, full body visible.
      ...
      scenes: [
        {
          ...
          prompt: `Place every person visible in this booth photo as Indian cricket World Cup champions celebrating on the field. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with the Indian cricket team uniform — current-style BCCI blue jersey, white trousers, spiked cricket shoes. One subject holds the ICC Cricket World Cup trophy aloft. All subjects celebrate together, full body visible.
...
Canon 1DX Mark III 300mm f/2.8, ultra photorealistic, professional cricket sports photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as IPL cricket superstars celebrating a championship victory. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with an IPL team jersey — Mumbai Indians blue or Chennai Super Kings yellow. Subjects celebrate with the IPL trophy in a group, full body visible.
...
Nikon D6 400mm f/2.8, ultra photorealistic, IPL sports photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as FIFA World Cup champion footballers celebrating on the pitch. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with a national football team jersey — blue or white, national crest, shorts and football boots. One subject holds the golden FIFA World Cup trophy above their head. Full body visible.
...
Sony A1 600mm f/4.0, ultra photorealistic, FIFA World Cup sports photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as Formula 1 World Championship winners on the F1 podium. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with a Formula 1 nomex fireproof race suit in Ferrari red, Mercedes silver or McLaren orange, with sponsor logos, team cap and balaclava rolled down. Subjects on the podium holding a trophy with champagne being sprayed. Full body visible.
      ...
      scenes: [
        {
          ...
          prompt: `Place every person visible in this booth photo as Bollywood celebrities at a grand Mumbai movie premiere. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with glamorous Bollywood premiere attire — Indian designer lehenga, saree or Indo-western fusion gown for women, or designer sherwani with Indian embroidery for men. All subjects stand together on the red carpet, full body visible.
...
Nikon D850 85mm f/1.8, ultra photorealistic, Bollywood entertainment photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as ISRO scientists at the ISRO Mission Control Center during a landmark mission. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with ISRO scientist attire — dark navy ISRO logo jacket or white shirt with ISRO mission badge, formal trousers or saree/churidar for women. All subjects stand confidently at mission control consoles, full body visible.
...
Canon R6 35mm f/2.8, ultra photorealistic, documentary journalism photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo as Maharajas and Maharanis in a grand Rajasthani palace. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with ornate traditional Indian royal attire — richly embroidered sherwani with jeweled turban and pearl necklaces for men, or grand Benarasi silk saree with polki diamond jewelry, maang tikka and nath for women. Full body visible.
...
Nikon Z7 II 85mm f/1.8, ultra photorealistic, royal portrait photography in the tradition of Raja Ravi Varma, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo at the Republic Day parade at Kartavya Path, New Delhi. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with formal Indian traditional attire — a formal achkan or kurta-pyjama for men, formal silk salwar kameez or saree in saffron, white or green for women — with a proud, dignified bearing. Full body visible.
      ...
      scenes: [
        {
          ...
          prompt: `Place every person visible in this booth photo inside a Boeing Business Jet private luxury aircraft. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with designer casual luxury travel attire — a cashmere sweater, tailored trousers or elegant travel dress, premium leather accessories. Each subject holds a crystal champagne flute or reclines naturally in the seat. Full body visible.
...
Leica Q2 28mm f/1.7, ultra photorealistic, luxury lifestyle aviation photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo in a luxury Manhattan penthouse with an infinity pool overlooking the New York City skyline at night. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with designer evening luxury wear — a sleek tailored suit or elegant cocktail dress in black or navy. Each subject holds a crystal champagne flute. Full body visible.
...
Sony A7R V 35mm f/1.4, ultra photorealistic, luxury lifestyle architectural photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo with an exotic supercar at a dramatic location. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with high-end designer casual fashion — premium fitted clothing, designer sunglasses, luxury watch on wrist. Subjects lean confidently against or stand beside the supercar in natural poses. Full body visible.
...
Canon 1DX Mark III 50mm f/2.8, ultra photorealistic, premium automotive advertising photography, 8K.`
        },
        {
          ...
          prompt: `Place every person visible in this booth photo walking the runway at Paris Fashion Week as headline models. Preserve each person's exact face, facial structure, skin tone, skin texture, hair color, hair style, eye color, body shape, height and proportions with absolute fidelity — do not alter, smooth, beautify or modify any feature. For [GENDER], replace booth outfit with an extraordinary haute couture runway look — an elaborate sculptural garment from a top Parisian fashion house (Dior, Chanel or Valentino aesthetic) with dramatic design elements. Subjects walk naturally down the runway with professional model posture. Full body visible.
      ...
      scenes: [
        {
          ...
          gradient: 'linear-gradient(135deg, #8B0000, #2d0000)',
          referenceImages: [
  'assets/references/tn-withcm.png',
  'assets/references/tn-cm-face.png'
],
          prompt: `image_1 is the captured guest. image_2 is the CM Vijay office scene — use this as the exact background and setting. image_3 is a close-up reference of CM Vijay's face — use this to preserve his identity with absolute accuracy.

PRESERVE CM VIJAY EXACTLY: His face must match image_3 precisely — skin tone, skin texture, eyes, nose, lips, beard stubble, hair — pixel-perfect. His white shirt, body, posture from image_2 — keep identical. Do not change, reinterpret or alter CM Vijay in any way whatsoever.
